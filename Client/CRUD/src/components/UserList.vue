                ...
                <div class="bg-white shadow-md rounded my-6 overflow-x-scroll">
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light ">
                            ...
                            <tr v-for="(user, index) in users" class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="mr-2">
                                            <!-- User image -->
...
function setActiveTutorial(user: User, index = -1) {
    currentUser = user;
...
function searchTitle() {
    UserDataService.findByTitle(title.value)
        .then((response: ResponseData) => {
            users = response.data;
            setActiveTutorial({} as User);
            console.log(response.data);
        })
        .catch((e: Error) => {
            console.log(e);
