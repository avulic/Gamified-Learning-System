...
<template>
    <div class="question-container space-y-6">
        ...
        <div class="form-field">
            ...
            <Dropdown v-model="localQuestion.questionType"
        ...
        <div class="form-field">
            ...
            <Field name="question" v-slot="{ field }">
                <Textarea v-model="localQuestion.question"
                    v-bind="field"
                    rows="3"
                    class="w-full" />
            </Field>
