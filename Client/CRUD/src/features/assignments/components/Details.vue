    ...
    <div class="p-4 bg-gray-100">
        <TabView>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="form-field">
                                    ...
                                    <Field name="passingScore" v-slot="{ field }">
                                        <InputNumber id="passingScore" v-model="assignment.passingScore"
                                            :disabled="!isEditable" v-bind="field" :min="0" :max="100"
                                            :class="{ 'p-invalid': errors.passingScore }" />
                                    </Field>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="form-field">
                                    ...
                                    <Field name="maxAttempts" v-slot="{ field }">
                                        <InputNumber id="maxAttempts" v-model="assignment.maxAttempts"
                                            :disabled="!isEditable" v-bind="field" :min="1"
                                            :class="{ 'p-invalid': errors.maxAttempts }" />
                                    </Field>
                                ...
                                <div class="form-field">
                                    ...
                                    <Field name="timeLimit" v-slot="{ field }">
                                        <InputNumber id="timeLimit" v-model="assignment.timeLimit"
                                            :disabled="!isEditable" v-bind="field" :min="0"
                                            :class="{ 'p-invalid': errors.timeLimit }" />
                                    </Field>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="col-span-2">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div v-if="assignment.submissionWindow.allowLateSubmissions"
                            ...
                            <div class="space-y-4">
                                ...
                                <div v-if="peerReviewEnabled" class="space-y-2">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <Calendar v-model="reviewDueDate" :disabled="!isEditable" showTime
                                            hourFormat="24" />
                                    </div>
                                </div>
                            </div>
            ...
            <TabPanel header="Tasks">
                <div class="space-y-4">
                    <TaskManager :assignment-id="assignment.id as string" :tasks="assignment.tasks"
                        :isEditable="isEditable" @update:tasks="updateTasks" @editTask="editTask"
...
import TaskManager from '@/features/tasks/components/task/TaskManager.vue';
