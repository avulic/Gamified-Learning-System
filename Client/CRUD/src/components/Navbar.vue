            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <ul class="flex items-center hidden space-x-8 lg:flex">
                        ...
                        <li>
                            <RouterLink :to="{ name: 'about' }" aria-label="Users" title="Users"
                                class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400">
                                About us</RouterLink>
                        </li>
                    </ul>
                ...
                <ul v-else class="flex items-center hidden space-x-8 lg:flex">
                    <li>
                        <a @click="logout"
                            class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400">Logout</a>
                    </li>
                </ul>
