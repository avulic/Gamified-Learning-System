<template>
    <Button v-if="!isEditable" label="Back to Courses" icon="pi pi-arrow-left" @click="$router.push('/courses')"
    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <ModuleSection :modules="course.modules" @add-lesson="openLessonDialog" @delete-module="confirmDeleteModule"
        ...
        <template v-if="isEditable">
            ...
            <Dialog v-model:visible="dialogs.assignment" modal header="Assignment Details" :style="{ width: '80vw' }"
...
import ModuleDialog from './dialogs/ModuleDialog.vue';
...
const course = ref<Course>(props.course || getEmptyCourse());
...
onMounted(async () => {
    ...
    course.value = await CourseService.getCourseDetailsById(props.course.id) as Course;
