<template>
    <div class="p-4 bg-gray-100">
        <TabView>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-field">
                                ...
                                <Field name="assignmentId" v-slot="{ field }">
                                    <Dropdown v-model="quiz.assignmentId" :options="assignmentOptions"
                                        optionLabel="title" optionValue="id" placeholder="Select Assignment"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="form-field">
                                    ...
                                    <Field name="content.timeLimit" v-slot="{ field }">
                                        <InputNumber v-model="quiz.content.timeLimit" :min="0"
                                ...
                                <div class="form-field">
                                    ...
                                    <Field name="content.passingScore" v-slot="{ field }">
                                        <InputNumber v-model="quiz.content.passingScore" :min="0" :max="100"
                                ...
                                <div class="form-field">
                                    ...
                                    <Field name="content.maxAttempts" v-slot="{ field }">
                                        <InputNumber v-model="quiz.content.maxAttempts" :min="1"
                        ...
                        <Panel header="Task Settings" class="mt-4">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="form-field">
                                    ...
                                    <Field name="points" v-slot="{ field }">
                                        <InputNumber v-model="quiz.points" :min="0" placeholder="Total points"
                                ...
                                <div class="form-field">
                                    ...
                                    <Field name="xpReward" v-slot="{ field }">
                                        <InputNumber v-model="quiz.xpReward" :min="0" placeholder="XP reward"
                                ...
                                <div class="form-field">
                                    ...
                                    <Field name="order" v-slot="{ field }">
                                        <InputNumber v-model="quiz.order" :min="0" placeholder="Display order"
                            ...
                            <div class="flex items-center gap-4 mt-4">
                                <div class="form-field">
                                    <Checkbox v-model="quiz.requiredForCompletion" :binary="true"
                                ...
                                <div class="form-field">
                                    ...
                                    <Calendar v-model="quiz.dueDate" showTime :showIcon="true" dateFormat="dd/mm/yy" />
                                </div>
                            </div>
                        </Panel>
                    </div>
            ...
            <TabPanel header="Questions">
                <div class="mb-4 flex justify-between items-center">
                    ...
                    <SplitButton label="Add Question" icon="pi pi-plus" :model="questionTypeOptions"
                        class="p-button-success" />
                </div>

                <DataTable :value="quiz.content.questions" v-model:selection="selectedQuestion" :reorderableRows="true"
                    @rowReorder="onQuestionReorder" dataKey="id" class="mb-4">
                    <Column rowReorder />
                    ...
                    <Column header="Actions" style="width: 8rem">
                        <template #body="{ data }">
                            <div class="flex gap-2">
                                ...
                                <Button icon="pi pi-trash" @click="deleteQuestion(data)"
        ...
        <Dialog v-model:visible="showQuestionDialog" :style="{ width: '70vw' }" :header="questionDialogTitle"
            :modal="true">
            <QuestionDetails v-if="currentQuestion" :question="currentQuestion" @save="saveQuestion"
...
import QuestionDetails from '@/features/tasks/components/questions/QuestionDetails.vue';
