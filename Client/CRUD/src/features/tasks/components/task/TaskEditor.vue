...
// Components
import QuestionTaskComponent from '@/features/tasks/components/questions/QuestionBase.vue';
import QuizTaskComponent from '@/features/tasks/components/quiz/QuizList.vue';
import FileUploadTaskComponent from '@/features/tasks/components/task/Upload.vue';
import CodeTaskComponent from '@/features/tasks/components/task/Code.vue';
